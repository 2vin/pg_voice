    ...
    def run(self):
        ...
        try:
            ...
            while True:
                ...
                os.system('clear')
                print("Say \'P&G\' to trigger voice action")
                result = porcupine.process(pcm)
                if num_keywords == 1 and result:
                	os.system('clear')
                	print('[%s] ---------detected keyword-------' % str(datetime.now()))
                	## --------------------------------------- EDITS ------------------------------------
                	os.system("./pico2wav.sh 'greet'")
                	print('\n\n\n\n\n\nTry saying \'Where is coca cola bottle?\' or \'What is the price of Oral B toothbrush?\'\n\n')
                	os.system("./speech-recog.sh")
                    ## ----------------------------------------------------------------------------------
